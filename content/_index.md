    ...
    content:
      ...
      items:
        ...
        - date_start: '2023-02-15'
          date_end: ''
          description: |2-
            <div style="float:left;margin-right:5px;"> <img src="gvf.jpg" width="60"/></div>The goal of that project is to develop principled techniqes that can detect deceptive conents in natural language conversions. These contents could be by humans or by Large Language Models (LLMs). These techniques are based on interpreting conversation contents and model internals. 
          icon: gvf
